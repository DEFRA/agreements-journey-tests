...
describe('Given the applicant has reviewed the WMP offer', () => {
  describe('When the applicant navigate to "Accept your offer" page', () => {
    ...
    it('should expand the guidance details section', async () => {
      ...
      expect(content).toContain(
        'Contact the Rural Payments Agency for help.\n' +
          'Phone: 03000 200 301\n' +
          'Monday to Friday, 8:30am to 5pm (except bank holidays)\n' +
          'Find out about call charges (opens in new tab)\n' +
          'Email: ruralpayments@defra.gov.uk\n' +
          'The RPA responds to email queries within 10 working days.'
      )
