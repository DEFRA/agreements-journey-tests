...
export async function sendTerminateOffer(clientRef, agreementNumber) {
  ...
  const payload = {
    ...
    specVersion: '1.0',
    type: 'cloud.defra.test.fg-gas-backend.agreement.terminated',
    ...
    data: {
      ...
      id: faker.string.uuid(),
      status: 'terminated',
      terminatedBy: 'Caseworker_ID_123',
      terminatedAt: '2025-03-27T14:30:00Z'
    }
  }
